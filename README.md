...
#### Installation
STRONG is already installed on your VM, you will find the git repos at : `/usr/local/STRONG`
...
Look at : `/usr/local/STRONG/conda_env.yaml`
...
**Databases**
 ...
 - [COG database](ftp://ftp.ncbi.nlm.nih.gov/pub/mmdb/cdd/little_endian) , you will find it installed at
    `/home/training/DB_folder/rpsblast_cog_db`
...
Let's create a working directory for STRONG:
    ...
    mkdir -p "/home/training/Strain_resolution/STRONG_run"
    cd /home/training/Strain_resolution/STRONG_run
...
length of reads : `grep -v "@" -m 1 sample1_R1.fastq.gz |wc -c`
...
We are now ready to run STRONG, the minimal command needed is : 
    ...
    STRONG /home/training/Strain_resolution --threads 8 --verbose --dryrun
...
# config file , all possible parameters
